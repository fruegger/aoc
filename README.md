...
* sets and other basic data structures, as well as generics, are unknown to mankind in Go ... The experience of implementing a surrogate method that would only add an element to a slice if it were not there already, felt pedestrian at best.
